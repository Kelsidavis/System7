 ...
 */
int SystemMenu_HandleSelection(int16_t itemID)
{
    if (!g_systemMenuInitialized) {
 ...
 */
void SystemMenu_SetItemEnabled(int16_t itemID, bool enabled)
{
    if (!g_systemMenuInitialized) {
        return;
    }
 ...
 */
void SystemMenu_SetItemChecked(int16_t itemID, bool checked)
{
    if (!g_systemMenuInitialized) {
        return;
    }
 ...
 * Get menu item count
 */
int16_t SystemMenu_GetItemCount(void)
{
 ...
 */
const MenuItem *SystemMenu_GetItem(int16_t index)
{
    ...
    MenuItem *item = g_systemMenu.firstItem;
    for (int16_t i = 0; i < index && item; i++) {
        item = item->next;
    }
 ...
 */
bool SystemMenu_IsEnabled(void)
{
 ...
 */
void SystemMenu_SetEnabled(bool enabled)
{
    if (g_systemMenuInitialized) {
