...
static bool g_deskMgrInitialized = false;

/* Internal Function Prototypes */
static int DA_AllocateRefNum(void);
static void DA_FreeRefNum(int16_t refNum);
...
void SystemMenu(int32_t menuResult)
{
    ...
    int16_t menuID = (menuResult >> 16) & 0xFFFF;
    int16_t itemID = menuResult & 0xFFFF;
                   ...
                   void *param1, void *param2)
{
    ...
    switch (message) {
        ...
        case DA_MSG_MENU:
            if (da->menu) {
                int16_t menuID = (int16_t)(intptr_t)param1;
                int16_t itemID = (int16_t)(intptr_t)param2;
