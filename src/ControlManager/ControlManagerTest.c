...
/* Test utilities */
static bool TestControlManager_Initialize(void);
static bool TestControlManager_StandardControls(void);
static bool TestControlManager_ScrollbarControls(void);
static bool TestControlManager_TextControls(void);
static bool TestControlManager_PopupControls(void);
static bool TestControlManager_ControlTracking(void);
static bool TestControlManager_ControlResources(void);
static bool TestControlManager_PlatformSupport(void);
static void TestControlManager_Cleanup(void);

/**
 * Run complete Control Manager test suite
 */
bool RunControlManagerTests(void) {
 ...
 * Test control resources
 */
static bool TestControlManager_ResourcesControls(void) {
 ...
 */
int main(void) {
    bool success = RunControlManagerTests();
    return success ? 0 : 1;
}