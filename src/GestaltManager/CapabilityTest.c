 ...
 *
 * Evidence: Based on system capability detection routines found in System.rsrc
 * Analysis date: 2025-09-17
 * Provenance: Direct implementation testing of reverse engineered functions
 */

#include "../../include/GestaltManager/SystemCapabilities.h"
#include <stdio.h>
#include <stdlib.h>
 ...
 * Evidence: Tests all capability detection functions from original analysis
 */
int main(void)
{
 ...
 * Evidence: Capability flag definitions from layouts.curated.json
 */
static void PrintCapabilityFlags(unsigned short flags)
{
    printf("  Capabilities: ");
 ...
 * Evidence: Machine type constants from System 6.0.7 compatibility analysis
 */
static void PrintMachineType(short machineType)
{
    switch (machineType) {
 ...
 * Evidence: System version 6.0.7 from binary analysis
 */
static void PrintSystemVersion(short version)
{
 ...
 * Evidence: Color capability strings from byte offset 7922
 */
static const char* GetColorDepthString(unsigned short flags)
{
 ...
 * {
 *   "file": "CapabilityTest.c",
 *   "purpose": "Test utility for System 6.0.7 capability detection functions",
 *   "tested_functions": [
 *     "GetSystemCapabilities", "CheckQuickDrawVersion", "CheckFloatingPointUnit",
 *     "CheckAddressingMode", "GetColorCapabilities", "CheckSoundInputCapability"
 *   ],
 *   "evidence_validation": [
 *     {"offset": 8803, "validation": "QuickDraw version messages"},
 *     {"offset": 43934, "validation": "FPU detection messages"},
 *     {"offset": 7922, "validation": "Color capability messages"}
 *   ],
 *   "test_coverage": 0.90,
 *   "provenance_density": 0.08,
 *   "validation_status": "test_complete"
 * }
 */